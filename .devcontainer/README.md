...
- build docker
    ```shell
    docker build . -t samge/hallo-test-dev-base -f .devcontainer/Dockerfile-dev-base --build-arg PROXY=http://192.168.50.48:7890
    ```

- upload
    ```shell
    docker push samge/hallo-test-dev-base
    ```
